...
class YouTubeDownloaderCore:
    ...
    def get_video_info(self, url: str) -> Optional[VideoInfo]:
        ...
        try:
            yt = YouTube(url, client='WEB_EMBED', use_po_token=True)
    ...
    # Metodo que añade los metadatos ID3 a los videos Auto Generated
    ...
    # Metodo que añade los metadatos basicos - No Auto Generated
    ...
    def _display_ffmpeg_warning(self):
        ...
        instructions = {
            'windows': (
                ...
                "   • C:\\ffmpeg\\  (o cualquier ubicación)\n"
                "4. Agrega a PATH:\n"
        ...
        warning_msg = f"""
{'='*60}
⚠️  ADVERTENCIA: FFmpeg NO ENCONTRADO
{'='*60}
        
• Funcionalidades limitadas
• Sin FFmpeg no puedes convertir a MP3/MP4 nativos
        
{instructions.get(system, 'Visita: https://ffmpeg.org/download.html')}
        
{'='*60}
💡 Tip: Reinicia la aplicación después de instalar FFmpeg
{'='*60}
"""        
        print(warning_msg)
